...
mem load -i {D:/arch/project/Pipelined-Processor/instructions.mem} /processor/IF_Stage/cache/fx/ram
...
add wave -position insertpoint  \
sim:/processor/IF_Stage/programCounter/count
add wave  \
sim:/processor/IF_Stage/programCounter/en
add wave -position insertpoint  \
sim:/processor/EX_Stage/aluOperation
add wave -position insertpoint  \
sim:/processor/EX_Stage/conditionalJump
add wave -position insertpoint  \
sim:/processor/ID_Stage/hdu1/StallPC_Fetch \
sim:/processor/ID_Stage/hdu1/StallDecodA \
sim:/processor/ID_Stage/hdu1/FlushFetchD \
sim:/processor/ID_Stage/hdu1/FlushDecodeA \
sim:/processor/ID_Stage/hdu1/FlushAluM
add wave -position insertpoint  \
